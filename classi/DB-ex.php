...
{       public $tipo   ='';  
   ...
   echo         $sql="SELECT * FROM ".self::$pref."xdb
...
/**==============================================================================
  ...
  Metodi:
 decod()              decodifica di campo di tabella per chiave 
 ============================================================================= */
...
{       public $tabella ='';
    ...
    public function decod()       // decodifica del campo chiave
           ...
           if (!$res2) die('DB_decod/decod:'.mysql_error());
              ...
              return $this->dec = $row[$this->descr] ;
            }
