...
=============================================================================
   *  Elargitori per ragione sociale
=============================================================================  */
...
$cmd = 'SELECT * FROM '.DB::$pref.'ind WHERE RagioneSociale LIKE :term ORDER BY RagioneSociale LIMIT 15';
$term = $_GET['term'] .'%';
...
$row_array = array();
 ...
 while ($row = $result->fetch(PDO::FETCH_ASSOC))
     {
        $row_array['id'] = $row['id'];
        $row_array['value'] = $row['RagioneSociale']." ". $row['referente'] ."-".$row['numero_iscrizione'];
